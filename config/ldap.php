            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', 'test.server')),
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN', 'ou=test,dc=net,dc=com'),
                ...
                */
                ...
                'username' => env('LDAP_USERNAME','cn=hcdcacctops,ou=group,ou=serve,ou=Network,dc=hcdcnet,dc=com'),
                'password' => env('LDAP_PASSWORD','passes'),
